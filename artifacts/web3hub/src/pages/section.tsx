...
const SECTION_COLORS: Record<string, string> = {
  ...
  presale:     "from-pink-50 to-rose-50 border-pink-100 dark:from-pink-950/30 dark:to-rose-950/30 dark:border-pink-900/50",
  ...
  mainnet:     "from-blue-50 to-indigo-50 border-blue-100 dark:from-blue-950/30 dark:to-indigo-950/30 dark:border-blue-900/50",
  unlock:      "from-amber-50 to-orange-50 border-amber-100 dark:from-amber-950/30 dark:to-orange-950/30 dark:border-amber-900/50",
  exchange:    "from-violet-50 to-purple-50 border-violet-100 dark:from-violet-950/30 dark:to-purple-950/30 dark:border-purple-900/50",
...
const SECTION_I18N_KEYS: Record<string, { label: string; desc: string }> = {
  ...
  presale:     { label: "sPresaleLabel",     desc: "sPresaleDesc" },
  ...
  mainnet:     { label: "sMainnetLabel",     desc: "sMainnetDesc" },
  unlock:      { label: "sUnlockLabel",      desc: "sUnlockDesc" },
  exchange:    { label: "sExchangeLabel",    desc: "sExchangeDesc" },
